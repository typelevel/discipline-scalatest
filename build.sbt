...
lazy val `discipline-scalatest` = project.in(file("."))
...
lazy val commonSettings = Seq(
  ...
  scalacOptions in (Compile, doc) ++= Seq(
      ...
      "-doc-source-url", "https://github.com/rossabaker/discipline-scalatest/blob/v" + version.value + "€{FILE_PATH}.scala"
  ),
...
lazy val releaseSettings = {
  ...
  Seq(
    ...
    scmInfo := Some(
      ScmInfo(
        url("https://github.com/rossabaker/discipline-scalatest"),
        "git@github.com:rossabaker/discipline-scalatest.git"
      )
    ),
    homepage := Some(url("https://github.com/rossabaker/discipline-scalatest")),
